        ...
        <div className='flex items-center gap-6 msm:gap-8'>
          <div className={`flex items-center p-1 bg-white shadow-md rounded-full transition-all duration-300 ease-in-out ${isSearchActive ? 'w-full' : ''}`}>
            <input
              ...
              className={`outline-none text-sm transition-width duration-300 ease-in-out ${isSearchActive ? 'w-48 px-2' : 'w-0'}`}
            ...
            <img
              src={search_icon2}
              alt="search_icon"
              className='w-8 cursor-pointer p-2 bg-[#f03e22] rounded-full'
